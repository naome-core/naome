...
pub use naome_protocol::research_exchange::*;
use naome_research::profile::Genesis;
...
impl StaticArtifactNetwork {
    ...
    pub fn new_research(
        ...
        network.swarm.behaviour_mut().research_exchange =
    ...
    pub fn request_research(
        ...
        let connected = self.swarm.behaviour().research_exchange.is_connected(&peer)
            && self
                .swarm
                .behaviour()
                .allowed
        ...
        let id = self.swarm.behaviour_mut().research_exchange.send_request(
            &peer,
            WireRequest {
