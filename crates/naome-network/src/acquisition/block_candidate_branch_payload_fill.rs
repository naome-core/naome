...
use super::{
    ARTIFACT_BLOCK_IMPORT_TIMEOUT, MAX_STATIC_PEERS, NetworkEvent, OutboundArtifactFailure,
    OutboundArtifactOutcome, PeerId, RequestStartError, StaticArtifactNetwork,
};
use crate::transport::payload_request::{ArtifactPayloadRequest, ArtifactPayloadRequestStarter};
    ...
    fn validated(
        ...
        let canonical_peer_ids =
            ...
            .map_err(|error| match error {
                ...
                ) => ArtifactBlockCandidateBranchPayloadFillError::EmptyPayloadPeerSet,
                crate::peer_selection::ConfiguredPeerSetError::Input(
