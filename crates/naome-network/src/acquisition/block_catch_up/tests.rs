...
use crate::{
    ArtifactBlockAncestryPullError, ArtifactBlockImportError, JournalServiceEvent,
    JournalServiceRequest, Keypair, NetworkEvent, RequestStartError,
};
...
fn pull_to_import(
    ...
    assert!(!network.has_pending_block_for_test());
