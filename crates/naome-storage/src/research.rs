...
impl From<naome_research::ResearchError> for ResearchStorageError {
    fn from(e: naome_research::ResearchError) -> Self {
        Self::Validation(e.to_string())
    }
}

impl From<naome_consensus::research::ResearchConsensusError> for ResearchStorageError {
    fn from(e: naome_consensus::research::ResearchConsensusError) -> Self {
        Self::Validation(e.to_string())
    }
}
