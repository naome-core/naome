...
//! strict provisioning, restart ordering, and consume-on-finality signer
//! coupling while deliberately leaving daemon, networking, timeout,
//! key-loading, and branch-selection policy to later components.
