...
- BASE-015 [DECIDED] [IMPLEMENTED] Given caller-supplied already-computed artifact base-fee atoms, the reference economy kernel partitions exact citation, validator, and burn atoms with full conservation; evidence: `crates/naome-economy/src/lib.rs`, `crates/naome-economy/src/tests.rs`.
- BASE-016 [DECIDED] [IMPLEMENTED] Given caller-supplied already-computed non-artifact operation-fee atoms, the reference economy kernel assigns zero citation atoms and partitions exact validator and burn atoms with full conservation; evidence: `crates/naome-economy/src/lib.rs`, `crates/naome-economy/src/tests.rs`.
